...
dframeP<-read.table("Data/SamplesNoctThreshold.txt", header=TRUE)
summary(dframeP)
...
write.table(metricsPT.good, "Data\\NetworkmetricsPTbySampleThreshold.txt", sep="\t", row.names=FALSE)
...
### output the dataframe to a .txt file to use in downstream analysis
write.table(metricsPTS.good, "Data\\NetworkmetricsPTbySeasonThreshold.txt", sep="\t", row.names=FALSE)
...
### output the dataframe to a .txt file to use in downstream analysis
write.table(metricsFV.good, "Data\\NetworkmetricsFVbySampleThreshold.txt", sep="\t", row.names=FALSE)
...
### output the dataframe to a .txt file to use in downstream analysis
write.table(metricsFVS.good, "Data\\NetworkmetricsFVbySeasonThreshold.txt", sep="\t", row.names=FALSE)
